...
- `HARDWARE_RESULTS_2026-09-25_TEXCOORDGEN2_CROSSED_STRAP_CHECK_INPUT_FRONTIER.md` — proves sustained 60-present progression beyond GXSetTexCoordGen2 and moves the frontier to pinned StrapScene::CheckInput
